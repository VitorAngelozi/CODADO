import type { ApiQuizLevelId, Level, Question } from '../types/backend';
...
const questionsByLevel: Record<ApiQuizLevelId, Question[]> = {
  easy: [
...
export function getQuestionsByLevel(level = 'easy'): Question[] {
  const normalizedLevel = level as ApiQuizLevelId;
  return questionsByLevel[normalizedLevel] ?? questionsByLevel.easy;
}
